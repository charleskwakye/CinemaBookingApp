...
class Theater extends Model
{
    ...
    //TODO remember to define optionality between seat and theater
    public function seats(){
        return $this->hasMany(Seat::class); // theater have many seats
    }

    public function showtimes(){
        return $this->hasMany(Showtime::class); // a theater has many showtimes
    }
