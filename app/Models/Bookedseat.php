...
class Bookedseat extends Model
{
    ...
    public function booking(){
        return $this->belongsTo(Booking::class)->withDefault(); // bookedseat belongs to booking
    }

    public function seat(){
        return $this->belongsTo(Seat::class)->withDefault();//a bookedseat belongs to a seat
    }
