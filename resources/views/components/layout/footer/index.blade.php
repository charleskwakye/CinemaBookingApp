<footer class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
    <div class="container flex flex-wrap items-center justify-between mx-auto dark:text-white">
        <div>Charles' Project Cinema - © {{ date('Y') }}</div>
        @env('local')
            <div class="p-2"
